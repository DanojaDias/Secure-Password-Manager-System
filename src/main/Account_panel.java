...
public class Account_panel extends JPanel{
    ...
    public Account_panel(String name,int id){
        super();
        this.name=name;
        this.id=id;
        ...
        JLabel edit_icon=new JLabel(new ImageIcon(this.getClass().getResource("image/edit.png")));
        JLabel edit=new JLabel("edit");
        JLabel delete_icon=new JLabel(new ImageIcon(this.getClass().getResource("image/delete-icon.png")));
        JLabel delete=new JLabel("delete");
        JLabel go=new JLabel(new ImageIcon(this.getClass().getResource("image/go.png")));
        JLabel detail_icon=new JLabel(new ImageIcon(this.getClass().getResource("image/info.png")));
        ...
        edit_panel.add(edit_icon);edit_panel.add(edit);
        delete_panel.add(delete_icon);delete_panel.add(delete);
        go_panel.add(go);
        name_panel.add(acc_name);
        detail_panel.add(detail_icon);detail_panel.add(detail);
        
        //editing image
        String nameaccount="facebook gmail dreamspark feels github hackerrank linkedin sumsung yahoo paypal ";
       if(nameaccount .contains(this.name) ==true){icon_panel.add(new JLabel(new ImageIcon(this.getClass().getResource("image/"+this.name+".png"))));}
       else{icon_panel.add(new JLabel(new ImageIcon(this.getClass().getResource("image/other.png"))));}
      //  icon_panel.add(new JLabel(new ImageIcon(this.getClass().getResource("image/"+"other"+".png"))));
